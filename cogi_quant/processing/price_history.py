# Module for quantitative stock data fetching and processing
# Series handling
...
def get_price_open_series(stock: Stock,
    ...
    **Examples**
    ...
    '''
    frame = stock.q.get_quote_frame(start=start_date, end=end_date, period=period, interval=time_interval)
    return frame['Open']
